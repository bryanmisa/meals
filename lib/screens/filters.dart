...
class _FilterScreenState extends State<FilterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ),
      body: WillPopScope(
        // The WillScope Widget will return data to other widgets
        // Navigator.of(context).pop will leave the screeen and pass the
        // data
        onWillPop: () async {
          // async is used for future passing the data for future
          Navigator.of(context).pop({
